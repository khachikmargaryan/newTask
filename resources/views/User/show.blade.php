                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a href="{{route('users')}}" type="button" class="btn btn-primary">Users</a>
                                <a href="{{route('locations')}}" type="button" class="btn btn-outline-primary ms-1">All Locations</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form id="delete-form" method="POST" action="{{route('location.delete', $location->id)}}"
                            ...
                            <a class="m-1" onclick="document.getElementById('delete-form').submit()">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
